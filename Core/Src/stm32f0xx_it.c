...
/**
  ...
  *        On Cortex-M0 all faults (bus fault, mem fault, usage fault) route here.
  *        We blink PB3 (LD3) at 10Hz using a bare-metal spin loop so the fault
  *        is visible on hardware even when the RTOS is completely dead.
  */
